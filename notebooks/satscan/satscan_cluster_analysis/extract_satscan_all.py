...
OUTPUT_CSV = OUTPUT_DIR / f"{OUTPUT_STEM}_clusters.csv"
OUTPUT_POLYGONS = OUTPUT_DIR / f"{OUTPUT_STEM}_polygons.geojson"
OUTPUT_CENTROIDS = OUTPUT_DIR / f"{OUTPUT_STEM}_centroids.geojson"
